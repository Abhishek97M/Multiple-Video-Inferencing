...
from utils.utilscomp import preprocess, invert_affine, postprocess, preprocess_video

# Video's path
video_src = '2.mp4'  # set int to use webcam, set str to read from a video file
